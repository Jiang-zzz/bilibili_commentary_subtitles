...
def find_user(xml_file_name, frequency):
    ...
    frequent_users_hash = {hash_code: count for hash_code, count in hash_count.items() if count > frequency}
    ...
    address_count_list = [tuple([f"{address_head}{id_}",count]) for id_, count in sorted_list]
